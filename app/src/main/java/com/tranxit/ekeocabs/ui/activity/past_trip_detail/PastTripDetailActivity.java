package com.tranxit.ekeocabs.ui.activity.past_trip_detail;
...
import com.tranxit.ekeocabs.data.network.model.Rating;
import com.tranxit.ekeocabs.ui.fragment.InvoiceDialogFragment;
...
public class PastTripDetailActivity extends BaseActivity {
    ...
    @OnClick({R.id.view_receipt,R.id.download_invoice})
