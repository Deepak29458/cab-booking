...
import com.tranxit.ekeocabs.chat.ChatActivity;
import com.tranxit.ekeocabs.common.CancelRequestInterface;
...
import com.tranxit.ekeocabs.data.network.model.ProviderService;
import com.tranxit.ekeocabs.data.network.model.ServiceType;
import com.tranxit.ekeocabs.ui.activity.main.MainActivity;
import com.tranxit.ekeocabs.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import static com.tranxit.ekeocabs.MvpApplication.PERMISSIONS_REQUEST_PHONE;
import static com.tranxit.ekeocabs.base.BaseActivity.DATUM;
...
public class ServiceFlowFragment extends BaseFragment implements ServiceFlowIView, CancelRequestInterface, DirectionCallback {
    ...
    @OnClick({R.id.sos, R.id.cancel, R.id.share_ride, R.id.call, R.id.chat,R.id.navBtn})
    ...
    private void initView(Datum datum) {
        ...
        if (provider != null) {
            ...
            Glide.with(activity()).load(provider.getDriverImage()).into(image);
        }
