...
import com.tranxit.ekeocabs.common.RecyclerItemClickListener;
import com.tranxit.ekeocabs.data.network.model.Address;
import com.tranxit.ekeocabs.data.network.model.AddressResponse;
import com.tranxit.ekeocabs.ui.adapter.PlaceAutoCompleteAdapter;
...
public class LocationPickActivity extends BaseActivity
    ...
    private void setLocationText(String address, LatLng latLng) {
        if(selectedEditText==null)return;
