...
import com.tranxit.ekeocabs.ui.activity.OnBoardActivity;
import com.tranxit.ekeocabs.ui.countrypicker.CountryPickerListener;
...
import com.tranxit.ekeocabs.ui.activity.otp.OTPActivity;
import com.tranxit.ekeocabs.ui.countrypicker.Country;
import com.tranxit.ekeocabs.ui.countrypicker.CountryPicker;
...
import static com.tranxit.ekeocabs.common.CommonValidation.Validation;
import static com.tranxit.ekeocabs.common.CommonValidation.isValidEmail;
import static com.tranxit.ekeocabs.common.CommonValidation.isValidPass;
import static com.tranxit.ekeocabs.common.CommonValidation.isValidPhone;
...
public class RegisterActivity extends BaseActivity implements RegisterIView {
    ...
    @OnClick({R.id.next,R.id.tvTermsCondition})
    ...
    private void register() {
        ...
        if(!tvReferCode.getText().toString().isEmpty()){
            map.put("refer_code",tvReferCode.getText().toString());
        }
