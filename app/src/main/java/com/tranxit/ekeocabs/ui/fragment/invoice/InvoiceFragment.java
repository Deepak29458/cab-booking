...
import com.tranxit.ekeocabs.common.cc_avenue.AvenuesParams;
import com.tranxit.ekeocabs.common.cc_avenue.CCAvenueWebViewActivity;
import com.tranxit.ekeocabs.common.cc_avenue.ServiceUtility;
import com.tranxit.ekeocabs.data.network.model.Datum;
import com.tranxit.ekeocabs.data.network.model.Message;
import com.tranxit.ekeocabs.data.network.model.Payment;
...
public class InvoiceFragment extends BaseBottomSheetDialogFragment implements InvoiceIView {
    ...
    @BindView(R.id.done)
    Button done;
    @BindView(R.id.download_invoice)
    Button download_invoice;
...
//            outstationNoOfDays.setText(String.format("%s Days", payment.getOutstationDays()));
    ...
    @OnClick({R.id.payment_mode, R.id.pay_now, R.id.done,R.id.download_invoice})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.download_invoice:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://keocabs.in/api/user/invoice/"+DATUM.getId()));
